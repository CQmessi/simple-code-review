package com.mx.openaicodesdk.git;
...
public class GitDemand {
    ...
    public GitDemand(String project, String branch, String author, String gitUrl, String gitUser, String gitPassword) {
    ...
    public String pushCode(String result) throws Exception {
        ...
        try {
            ...
            String substring = this.gitUrl.substring(0, this.gitUrl.length() - 4);
            return substring + "/blob/master" + "/" + dateFolderName + "/" + fileName;
